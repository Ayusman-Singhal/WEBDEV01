<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -right-32 w-96 h-96 bg-gray-50 rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
      <div class="absolute -bottom-40 -left-32 w-96 h-96 bg-gray-50 rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="max-w-7xl mx-auto mb-20">
        ...
        <div class="text-center transform hover:scale-105 transition-transform duration-500">
          ...
          <p class="text-gray-600 leading-relaxed text-lg max-w-4xl mx-auto">
      ...
      <div class="max-w-7xl mx-auto mb-20">
        <div class="text-center mb-12">
          <h2 class="text-3xl font-bold text-gray-900 mb-8">Meet The <span class="text-yellow-600">Team</span></h2>
          <!-- Category Navigation -->
          <div class="flex flex-wrap justify-center gap-4 mb-12">
            <button 
              ...
              :class="selectedCategory === category ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-blue-50'"
            >
              {{ category }}
            </button>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            ...
            :key="member.name"
            class="group bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
          >
            <div class="flex flex-col items-center">
              ...
              <p class="text-blue-600 mb-4">{{ member.role }}</p>
              <p class="text-gray-600 text-sm italic mb-6 leading-relaxed">"{{ member.quote }}"</p>
              <a 
      ...
      <div class="max-w-7xl mx-auto mb-20">
        <div class="text-center">
          <h2 class="text-3xl font-bold text-gray-900 mb-4">Join Our <span class="text-yellow-600">Team</span></h2>
  ...
  <!-- Footer -->
  <footer class="max-w-full border-t border-white/10 pt-16 pb-8">
