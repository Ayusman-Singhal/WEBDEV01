  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="fixed right-0 inset-y-0 pointer-events-none overflow-hidden w-96 opacity-40 hidden lg:block">
      ...
      <div class="absolute bottom-1/3 right-12 animate-float-slow" style="animation-delay: -3s;">
        <svg width="280" height="280" viewBox="0 0 100 100" fill="none" stroke="currentColor" class="text-yellow-400">
    ...
    <div class="max-w-7xl mx-auto">
          ...
          >
            <div class="flex flex-col items-center">
              <div class="relative mb-6">
                ...
                <img :src="member.image" :alt="member.name" class="w-32 h-32 rounded-full object-cover relative z-10 ring-4 ring-white/10 group-hover:ring-yellow-500/50 transition-all">
              </div>
      ...
      <div class="max-w-7xl mx-auto pb-20">
        <div class="text-center">
          ...
          <router-link 
            to="/careers" 
            class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-yellow-500 to-purple-500 text-white rounded-lg font-semibold hover:from-yellow-600 hover:to-purple-600 transition-all duration-300 shadow-lg"
          >
            See Open Positions
