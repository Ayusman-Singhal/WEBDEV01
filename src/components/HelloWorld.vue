<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="w-full py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 grid grid-cols-2 gap-12 relative overflow-hidden">
        ...
        <div class="flex flex-col justify-center">
          ...
          <button 
            @click="router.push({ name: 'BecomeTutor' })" 
            class="bg-emerald-500 text-white px-8 py-4 rounded-lg w-fit hover:bg-emerald-600 transition-colors text-lg font-medium">
            Get Started
          </button>
        </div>
    ...
    <!-- Stats Section -->
    <section id="stats-section" class="w-full bg-gray-900/5 py-24">
        ...
        <div class="space-y-16">
          ...
          <div class="grid grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <div class="text-center mt-12">
                <a @click="router.push({ name: 'BecomeTutor' })"
                   class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-lg font-semibold rounded-xl 
                          hover:from-blue-600 hover:to-indigo-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer">
          ...
          <div class="grid grid-cols-2 gap-8 items-center">
            ...
            <div class="relative">
              <div class="bg-coral-light rounded-blob p-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-full h-full">
                  <path fill="#FF6B6B" d="M19 4h-1V3c0-.55-.45-1-1-1s-1 .45-1 1v1H8V3c0-.55-.45-1-1-1s-1 .45-1 1v1H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM19 20H5V10h14v10z"/>
                </svg>
              </div>
            </div>
          </div>
    ...
    <!-- Reviews Section -->
    <section class="py-24 bg-gradient-to-br from-orange-400 to-yellow-300 relative">
      <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl font-bold text-white mb-16">Customer Satisfaction</h2>

        <!-- Reviews Grid -->
        <div class="grid grid-cols-2 gap-16 items-center mb-12">
          <!-- Left: Review Content -->
...
onMounted(() => {
  ...
  setTimeout(() => animateCounter(tutorsCount, 1500, 2000), 500)
  setTimeout(() => animateCounter(citiesCount, 10, 1500), 500)
  setTimeout(() => animateCounter(studentsCount, 10000, 2000), 500)
})
</script>
