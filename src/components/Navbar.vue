        ...
        <header class="bg-stone-950 shadow-md">
            <nav class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <ul class="hidden md:flex space-x-6">
                    ...
                    <li>
                        <router-link to="#contact" class="text-gray-300 hover:text-amber-100 hover:underline underline-offset-4 transition-colors duration-200 flex items-center">
                ...
                <div v-if="islogged" class="relative ml-4">
                    <button
