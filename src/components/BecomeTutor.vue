<template>
  <div class="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 via-indigo-900 to-gray-900">
    <!-- Decorative Doodles -->
    ...
    <div v-if="!showForm" class="max-w-7xl mx-auto mb-20">
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div v-for="(benefit, index) in benefits" :key="index"
          ...
          <div class="relative">
            ...
            <h3 class="text-xl font-semibold text-white mb-4">{{ benefit.title }}</h3>
      ...
      <div class="text-center mt-16">
        <button @click="showForm = true"
          ...
          <span class="relative z-10 text-white text-lg">Start Your Teaching Journey</span>
...
const handleSubmit = async () => {
  try {
    ...
    if (form.value.certificates) {
      form.value.certificates.forEach(cert => {
...
const benefits = [
  {
    ...
    description: 'Design your own teaching schedule. Work when and where you want, maintaining the perfect work-life balance.',
    icon: 'ClockIcon'
  },
  {
    title: 'Competitive Earnings',
    description: 'Set your own rates and earn what you deserve. Top tutors earn up to $100/hour with performance bonuses.',
    icon: 'CurrencyDollarIcon'
  },
  {
    title: 'Professional Growth',
    description: 'Access exclusive training resources, join mentor programs, and collaborate with expert educators worldwide.',
    icon: 'AcademicCapIcon'
  }
]

// Define icon components (you can use your preferred icon library)
const ClockIcon = {
